...
export function useBooksList(token, searchedValue = "all", category = "") {
  return useQuery(["booksList", searchedValue, category], () =>
    getBooksList({ token, searchedValue, category })
  );
}
